...
Use this guide to get **Claude Code**, **Cursor**, **Codex**, or **OpenCode** installed on Linux without mixing in MCP or AIRIS setup.
...
Because Linux distributions vary, prefer the vendor's official install path for each tool instead of distro-specific guesses in this repo.

## Tool installation

### Claude Code
1. Install Claude Code using Anthropic's official Linux instructions.
2. Confirm the CLI launches successfully from your shell.
...
### Cursor
1. Install Cursor using its official Linux distribution path.
2. Launch it once and confirm it can open a local folder.
...
### Codex
1. Install Codex from OpenAI's official Linux instructions.
...
### OpenCode
1. Install OpenCode from its official Linux instructions.
...
These Linux steps are only for **installation and basic readiness**.
